...
<html lang="zh-CN">
  ...
  <li>数据库信息正确.</li>
	            ...
	            <p>
	            	<a style="color: red;"  target="_blank">安装完成右上角登录后点击头图进入后台 找到插件  安装表白墙配置插件 然后 找到模板 将表白墙模板同时设置为 移动端 和pc端模板</a>
	            </p>
			...
			<div class="row" id="div1" style="">
				...
				<table class="table table-bordered" style="background:#FFF">
				 ...
				 <tbody>
				 	<tr>
				 		<td>My SQL (3306)</td>
				 		<td><?php if(extension_loaded('pdo_mysql')) ok('支持'); else no('已禁用 (不可忽略)'); ?></td>
				 	</tr>
				 	<tr><td>
				 		目前HYBBS仅支持 MYSQL
				 	</td></tr>
														...
														$.ajax({
															...
															success:function(e){
																if(!e.error)
																	...
																	app_text('<i class="fa fa-check"></i> <a style="color:#217DCD" href="'+e.url+'">访问网站</a> ');
																}

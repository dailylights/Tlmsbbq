...
function load_friend(){
    $.ajax({
        ...
        success:function(e){
            ...
            for(o in e){
                if(e[o].state==0){
                    html0 += '<li><a onclick="new_chat(\'title\',\'ssss\',444,465,'+e[o].uid+',\''+e[o].user+'\',\''+e[o].avatar.b+'\',\''+((e[o].ps==null)?'':e[o].ps)+'\')" class="clearfix">'+
                    ...
                    html2 += '<li><a onclick="new_chat(\'title\',\'ssss\',444,465,'+e[o].uid+',\''+e[o].user+'\',\''+e[o].avatar.b+'\',\''+((e[o].ps==null)?'':e[o].ps)+'\')" class="clearfix">'+
                    '<img src="'+WWW+e[o].avatar.b+'" class="img-circle" alt="user avatar">'+
                    '<div class="chat-detail m-left-sm"><div class="chat-name">'+e[o].user+
                    '</div><div class="chat-message">'+((e[o].ps==null)?'':e[o].ps)+'</div>'+
                    '</div><div class="chat-status"><span class="friend-'+(e[o].ol?'zx':'lx')+'"></span></div>'+
                    ...
                    html3 += '<li><a onclick="new_chat(\'title\',\'ssss\',444,465,'+e[o].uid+',\''+e[o].user+'\',\''+e[o].avatar.b+'\',\''+((e[o].ps==null)?'':e[o].ps)+'\')" class="clearfix">'+
                    '<img src="'+WWW+e[o].avatar.b+'" class="img-circle" alt="user avatar">'+
                    '<div class="chat-detail m-left-sm"><div class="chat-name">'+e[o].user+
                    '</div><div class="chat-message">'+((e[o].ps==null)?'':e[o].ps)+'</div>'+
                    '</div><div class="chat-status"><span class="friend-'+(e[o].ol?'zx':'lx')+'"></span></div>'+
...
function add_friend_li(uid){
    $.ajax({
        ...
        success:function(e){
            if(e.error){
                var html = '<li><a onclick="new_chat(\'title\',\'ssss\',444,365,'+uid+',\''+e.info.user+'\',\''+e.info.avatar.b+'\')" class="clearfix">'+

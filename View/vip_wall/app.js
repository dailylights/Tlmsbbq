...
function open_lt(username,uid,avatar){
	...
	if(_this.length == 0){
		...
		$.hy.show_iframe(obj);
		var box = $('<div style="background: #30D0DF;width:100%;height:100%"><header class="hy-header hy-bo-b"><a class="hy-header-nav hy-header-left icon icon-chevron-small-left" onclick="hide_lt('+uid+')"></a><h1 class="hy-header-title">'+username+'</h1><a class="hy-header-nav hy-header-right" onclick=""></a></header></div>');
		obj.append(box);
